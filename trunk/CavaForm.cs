...
namespace CavaPlugin
{
    public partial class CavaForm : Form
    {
        ...
        {
            Process.Start("https://cavaprofiles.net/index.php/profiles/profiles-list/armageddoner");
        }
        ...
        {
            Process.Start("https://cavaprofiles.net/index.php/profiles/profiles-list/cavaprofessions/blacksmithing-1");
        }
        ...
        {
            button_Click();
            var sInfo = new ProcessStartInfo("https://cavaprofiles.net/index.php/account/create-new-user");
            Process.Start(sInfo);
        }
